...
<template>
  <CardBoxModal v-model="isModalActive" title="View Detail Property">
    <span> <b>Categpry :</b></span
    ><span>{{ selectedProperty.category }}</span>
    <br />
    <span> <b>Bathroom Count :</b></span
    ><span>{{ selectedProperty.bathroom_count }}</span>
    <br />
    <span> <b>Room Count :</b></span
    ><span>{{ selectedProperty.room_count }}</span>
    <br />
    <span> <b>Area :</b></span
    ><span>{{ selectedProperty.area }}</span>
    <br />
    <span> <b>Rent Type:</b></span
    ><span>{{ selectedProperty.rent_type }}</span>
    <br />
    <span> <b>Price :</b></span
    ...
    ><span>{{ selectedProperty.category }}</span>
    <br />
    <span> <b>Equipped :</b></span
    ><span v-if="selectedProperty._equipped">Equipped</span>
...
export default {
  ...
  methods: {
    ...
    async getProperty(property) {
      await axios
        .get(this.PROPERTY_API_BASE_URL + `/${property.id}`)
        .then((response) => {
    ...
    deleteProperty(id) {
      swal({
        ...
        if (willDelete) {
          axios
            .delete(`http://localhost:8000/manage-properties/delete/${id}`)
            .then((response) => {
