...
export default {
  ...
  data() {
    return {
      Properties_API_BASE_URL: "http://localhost:8000/manage-properties",
      equipped: [
  ...
  methods: {
    getPropertyById() {
      ...
      axios
        .get("http://localhost:8000/manage-properties/properties/" + id)
        .then((response) => {
    ...
    async updateProperty() {
      ...
      await axios
        .put(
          `http://localhost:8000/manage-properties/update/${this.property.id}`,
          this.property
        )
        .then(() => {
          swal({
    ...
    async getCategories() {
      await axios
        .get(this.Properties_API_BASE_URL + "/categories")
        .then((response) => {
    ...
    async getRentTypes() {
      await axios
        .get(this.Properties_API_BASE_URLL + "/rent-types")
        .then((response) => {
    ...
    async latestPropertyId() {
      ...
      await axios
        .get(this.Properties_API_BASE_URL + "/latest-property-id")
        .then((response) => {
